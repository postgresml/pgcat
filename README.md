...
| `worker_threads`             | The number of tokio worker threads                                                                                                         | `4`                              |
...
| `idle_timeout`               | Maximum time a server connection is allowed to be idle before being closed (milliseconds).                                                 | `30000`                          |
...
| `log_connections`            | Whether or not PgCat should log client connections                                                                                         | `false`                          |
| `log_disconnections`         | Whether or not PgCat should log client disconnections                                                                                      | `false`                          |
| `admin_username`             | Username for the admin database (accessed by connecting to postgres://user:password@host:port/pgcat or pgbouncer)                          | `admin_user`                     |
| `admin_password`             | Password for the admin database (accessed by connecting to postgres://user:password@host:port/pgcat or pgbouncer)                          | `admin_password`                 |
| `tls_certificate`            | path to certificate file                                                                                                                   | `<UNSET>`                     |
| `tls_private_key`            | path to private key                                                                                                                        | `<UNSET>`                     |
| **`user`**                   |                                                                                                                                            |                                  |
