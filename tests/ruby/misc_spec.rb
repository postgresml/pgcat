...
describe "Miscellaneous" do
  ...
  describe "Extended Protocol handling" do
    it "does not send packets that client does not expect during extended protocol sequence" do
      new_configs = proxies.main.current_config
      ...
      proxies.main.update_config(new_configs)
      ...
      sleep(0.5)
      conn_under_test = PG::connect(proxies.main.connection_string("sharded_db", "sharding_user"))
