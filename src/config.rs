...
pub struct Pool {
    ...
    #[serde(default = "Pool::default_table_mutation_cache_ttl")]
    pub table_mutation_cache_ttl: u64,
...
impl Pool {
    ...
    pub fn default_table_mutation_cache_ttl() -> u64 {
        // 50 milliseconds
        50
    }
    ...
    pub fn validate(&mut self) -> Result<(), Error> {
        ...
        if self.db_activity_based_routing {
            ...
            if self.table_mutation_cache_ttl == 0 {
                error!("table_mutation_cache_ttl must be greater than 0");
                return Err(Error::BadConfig);
            }
...
impl Default for Pool {
    fn default() -> Pool {
        Pool {
            ...
            table_mutation_cache_ttl: Self::default_table_mutation_cache_ttl(),
            plugins: None,
    ...
    pub fn show(&self) {
        ...
        for (pool_name, pool_config) in &self.pools {
            ...
            info!(
                ...
                pool_name, pool_config.table_mutation_cache_ttl
            );
            info!(
